...
export default async function StoreApiDetail({params}) {
  ...
  return (
    <Fragment>
      ...
      <div className='flex flex-col w-[95%] md:w-[50%] m-auto text-center '>
      ...
      <div className='flex flex-row justify-around  w-[100%] py-2 '>
              <div className=' w-[42%] bg-blue-400 text-center h-[50px] rounded-md text-[25px] '><Link  href={`/storeproject/`}>back to store </Link></div>
              <div className=' w-[42%] bg-green-400 text-center h-[50px] rounded-md text-[25px] '>add to card </div>
              </div> 
